          ...
          <div style={{ padding: "32px 36px" }}>
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              ...
              <button type="submit" disabled={loading} style={{
                padding: "13px", borderRadius: 12, background: "linear-gradient(135deg,#1e3a5f,#2a5298)",
            ...
            <div style={{ marginTop: 16, padding: "12px 14px", background: "#f0fdf4", border: "1px solid #bbf7d0", borderRadius: 8, fontSize: 12, color: "#16a34a" }}>
              <strong>Setup:</strong> Create an admin user in Supabase Auth, then set their role to <code>admin</code> in the profiles table.
            </div>
          </div>
        </div>
      </div>
